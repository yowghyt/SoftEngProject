...
INSERT INTO `knowledgecenterlog` (`idLog`, `userId`, `date`, `timeIn`, `roomName`) VALUES
(1, 4, '2025-10-16', '09:10:00', '424'),
(2, 3, '2025-10-16', '10:00:00', '424'),
(3, 2, '2025-10-17', '08:45:00', '424'),
(4, 1, '2025-10-18', '14:00:00', '424'),
(5, 1, '2025-10-19', '09:25:00', '424');
...
(1, 1, '2025-10-16', '10:00:00', 'Printed thesis draft'),
(2, 2, '2025-10-17', '14:30:00', 'Printed project report'),
(3, 3, '2025-10-17', '15:10:00', 'Printed lab worksheet');
...
--
ALTER TABLE `byodlog`
  ADD CONSTRAINT `fk_byodlog_room` FOREIGN KEY (`roomName`) REFERENCES `room` (`roomName`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `FKroomNameBYOD` FOREIGN KEY (`roomName`) REFERENCES `room` (`roomName`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `FKuserIdBYOD` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE `knowledgecenterlog`
  ADD CONSTRAINT `fk_kclog_room` FOREIGN KEY (`roomName`) REFERENCES `room` (`roomName`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `FKroomNameKC` FOREIGN KEY (`roomName`) REFERENCES `room` (`roomName`) ON DELETE RESTRICT ON UPDATE CASCADE,
  ADD CONSTRAINT `FKuserIdKC` FOREIGN KEY (`userId`) REFERENCES `users` (`userId`) ON DELETE RESTRICT ON UPDATE RESTRICT;
